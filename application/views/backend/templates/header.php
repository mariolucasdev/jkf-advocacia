...
<head>
  ...
  <link
    href="<?=base_url()?>assets/frontend/img/favicon.ico" rel="icon">
  <!-- Bootstrap 3.3.7 -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?=base_url('assets/backend/')?>index2.html" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>A</b>LT</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>AVANTI</b> manage</span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top">
      <!-- Sidebar toggle button-->
      <a href="<?=base_url('assets/backend/')?>#" class="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li>
            <a href="<?=base_url('assets/backend/')?>#" data-toggle="control-sidebar"><i class="fa fa-singout"></i></a>
          </li>
        </ul>
      </div>
    </nav>
